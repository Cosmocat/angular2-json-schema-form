(function (global, factory) {
    ...
    (factory((global.angular2JsonSchemaForm = {}),global.tslib,global.rxjs.Observable,global.rxjs.observable.fromPromise,global.rxjs.operator.toPromise,global.ng.core,global.rxjs.observable.forkJoin,global.rxjs.operator.map,global._,global.ng.forms,global.rxjs.Subject,global.Ajv,global.moment,global.ng.platformBrowser,global.ng.common,global['ngx-ckeditor'],global['ng2-date-picker'],global.ng['flex-layout'],global.angularFontAwesome,global.ng.material));
}(this, (function (exports,tslib,Observable,fromPromise,toPromise,core,forkJoin,map,lodash,forms,Subject,Ajv,moment,platformBrowser,common,ngxCkeditor,ng2DatePicker,flexLayout,angularFontAwesome,material) { 'use strict';
